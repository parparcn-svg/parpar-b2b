...
export default async function DistributorGuidePage({ params }: { params: Promise<{ lang: string }> }) {
      ...
      <Script id="guide-breadcrumb-schema" type="application/ld+json" strategy="beforeInteractive">
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Distributor Partnership Guide", item: `https://parpareg.com/${lang}/guides/pest-control-distributor-partnership` },
          ],
        })}
      </Script>
