...
const products: Product[] = [
  ...
  },
  {
    ...
    galleryImages: [
      ...
      "/images/parpar-mosquito-repellent-spray-product-angle-2.jpg",
      "/images/parpar-mosquito-repellent-spray-product-angle-3.jpg",
      "/images/parpar-mosquito-repellent-spray-product-angle-4.jpg",
      "/images/parpar-mosquito-repellent-spray-product-angle-5.jpg",
      "/images/parpar-mosquito-repellent-spray-with-packaging-box.png",
    ],
    sceneImages: [],
  },
  {
    ...
    galleryImages: [
      "/images/parpar-mosquito-liquid-bottle-color-corrected-product.png",
  ...
  },
  {
    ...
    galleryImages: [
      ...
      "/images/parpar-mosquito-liquid-large-heater-large-heater-packaging-isolated.png",
    ],
    sceneImages: [
      ...
      "/images/parpar-mosquito-liquid-large-heater-on-stone-platform-beige-bg.jpg",
    ],
  },
  {
    id: "P005",
