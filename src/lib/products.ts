...
const products: Product[] = [
  {
    ...
    galleryImages: [
      ...
      "/images/parpar-cockroach-killer-spray-product-top-angle-view.jpg",
      "/images/parpar-cockroach-killer-spray-complete-set-with-box.jpg",
    ],
    sceneImages: [
      "/images/parpar-cockroach-killer-spray-lifestyle-kitchen-action.jpg",
      "/images/parpar-cockroach-killer-spray-usage-indoor-scene.jpg",
    ],
  },
  {
    id: "P002",
    ...
    galleryImages: [
      ...
      "/images/parpar-mosquito-repellent-spray-product-top-angle-view.jpg",
      "/images/parpar-mosquito-repellent-spray-complete-set-with-box.jpg",
    ],
    sceneImages: [
      "/images/parpar-mosquito-repellent-spray-lifestyle-bedroom-protection.jpg",
      "/images/parpar-mosquito-repellent-spray-usage-outdoor-scene.jpg",
    ],
  },
  {
    id: "P003",
    ...
    mainImage: "/images/parpar-mosquito-liquid-bottle-hero-product-shot.jpg",
    galleryImages: [
      "/images/parpar-mosquito-liquid-bottle-isolated-front-angle.jpg",
      "/images/parpar-mosquito-liquid-bottle-packaging-box-display.jpg",
      "/images/parpar-mosquito-liquid-bottle-product-angle-detail.jpg",
      "/images/parpar-mosquito-liquid-bottle-complete-set-with-box.jpg",
    ],
    sceneImages: [
      "/images/parpar-mosquito-liquid-bottle-lifestyle-hand-holding.jpg",
      "/images/parpar-mosquito-liquid-bottle-usage-vaporizer-device.jpg",
    ],
  },
  {
    id: "P004",
    ...
    mainImage: "/images/parpar-mosquito-liquid-large-heater-hero-product-shot.jpg",
    galleryImages: [
      "/images/parpar-mosquito-liquid-large-heater-isolated-front-angle.jpg",
      "/images/parpar-mosquito-liquid-large-heater-packaging-box-display.jpg",
      "/images/parpar-mosquito-liquid-large-heater-product-side-angle.jpg",
      "/images/parpar-mosquito-liquid-large-heater-complete-kit-with-liquid.jpg",
    ],
    sceneImages: [
      "/images/parpar-mosquito-liquid-large-heater-lifestyle-living-room-use.jpg",
      "/images/parpar-mosquito-liquid-large-heater-usage-hotel-bedroom-scene.jpg",
    ],
  },
  {
    id: "P005",
    ...
    mainImage: "/images/parpar-mosquito-liquid-spherical-heater-hero-product-shot.jpg",
    galleryImages: [
      "/images/parpar-mosquito-liquid-spherical-heater-isolated-product-angle.jpg",
      "/images/parpar-mosquito-liquid-spherical-heater-packaging-box-display.jpg",
      "/images/parpar-mosquito-liquid-spherical-heater-product-side-angle.jpg",
      "/images/parpar-mosquito-liquid-spherical-heater-complete-kit-with-liquid.jpg",
    ],
    sceneImages: [
      "/images/parpar-mosquito-liquid-spherical-heater-lifestyle-bedroom-use.jpg",
      "/images/parpar-mosquito-liquid-spherical-heater-usage-night-scene.jpg",
    ],
  },
];
